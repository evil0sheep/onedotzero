...
5. Make an ansible playbook to install vLLM on the compute nodes (and the control node if needed) configured for clustered inference. For testing we should use Mistral-Small-Instruct-2409 quantized to 4 bits. For now we o
